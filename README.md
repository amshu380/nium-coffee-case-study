...
The dashboard runs locally. Clone the repo, pip install -r requirements.txt, then streamlit run dashboard/app.py. It opens at localhost:8501. The read-only connection string is shared by email.
